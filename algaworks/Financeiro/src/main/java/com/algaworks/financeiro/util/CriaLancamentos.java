...
public class CriaLancamentos {
	public static void main(String[] args) {
		...
		/**
		 * Instanciamos os objetos que queremos persistir e chamamos o método
		 * EntityManager.persist() em cada um deles. Depois, fazemos commit na
		 * transação e fechamos oEntity Manager.
		 */
